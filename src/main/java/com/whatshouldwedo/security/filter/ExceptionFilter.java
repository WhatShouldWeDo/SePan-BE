...
import com.whatshouldwedo.core.exception.type.HttpSecurityException;
...
public class ExceptionFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            log.error("FilterException throw IllegalArgumentException : {}", e.getMessage());
            request.setAttribute("exception", ErrorCode.INVALID_SECURITY_INFO);
            filterChain.doFilter(request, response);
        } catch (Exception e) {
